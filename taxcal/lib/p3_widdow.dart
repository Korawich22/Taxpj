...
import 'package:taxcal/p4_widdow.dart';

class P3widdow extends StatefulWidget {
  final String income;
  ...
  @override
  _P3widdowState createState() => _P3widdowState();
}

class _P3widdowState extends State<P3widdow> {
